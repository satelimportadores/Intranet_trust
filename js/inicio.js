$(document).ready(function() {
 ...
 //traer datos de cheques pendientes

 	$.ajax({
 		url: 'php/consultas_inicio.php',
 		type: 'POST',
 		data: {'cheques_pendientes': 'cheques_pendientes'},
 	})
 	.done(function(data) {
 		//console.log("success"+data);
 		var ArrayInfo = jQuery.parseJSON(data);
 		cantidad = ArrayInfo[0].cantidad;
 		porcentaje = ArrayInfo[0].porcentaje;
 		$('#cheques_pendientes').attr('data-value', cantidad);
 		$('#por_cheques_pendientes').attr('data-value', porcentaje);
 		$("#barra_cheques_pendientes").animate({width: porcentaje}, 500);	
  		runCallback()
