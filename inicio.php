        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top collapsed" role="navigation" id="navbar">
          ...
          <div class="navbar-header col-md-2">
            <a class="navbar-brand" href="index.html">
              <strong>TRUST</strong> CORPORATION
            </a>
       ...
       <!-- sidebar menu -->
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i>TRUST CORPORATIONS SAS
            <span> Gestión de cheques</span></h2>
                  ...
                  <div class="front"> 
                    ...
                    <div class="media">        
                      ...
                      <div class="media-body">
                        <small>Cheques pendientes</small>
                        <h2 class="media-heading animate-number" id="cheques_pendientes" data-value="" data-animation-duration="1500">0</h2>
                      </div>
                    </div> 
                    ...
                    <div class="progress-list">
                      ...
                      <div class="status pull-right bg-transparent-black-1">
                        <span class="animate-number" id="por_cheques_pendientes" data-value="" data-animation-duration="1500">0</span>%
                      </div>
                      <div class="clearfix"></div>
                      <div class="progress progress-little progress-transparent-black">
                        <div class="progress-bar animate-progress-bar" id="barra_cheques_pendientes" data-percentage=""></div>
                      </div>
                    </div>
