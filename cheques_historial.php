              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h1><strong>Cheques historial</h1>
                    <div class="controls">
                  ...
                  <div class="tile-body nopadding">
                    ...
                    <table class="table table-bordered table-striped" id="TblCheques">
                      <thead>
                        ...
                        <!-- tdody se llena por ajax desde php/consulta_cheques_datatable.php -->
                    </table>
...
<!-- CONTENIDO -->
            ...
            <!-- modal de edicion -->
                  <div id="modal_editar" class="modal fade"  data-keyboard="false" role="dialog">
                      ...
                      <div class="form-group">
                        ...
                        <div class="">
                          <input type="text" class="form-control" name="num_cheque" id="num_cheque" parsley-trigger="change" readonly="readonly" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                                            ...
                                            <div class="form-group">
                        <label for="nom_banco" class=" control-label">Nombre del banco</label>
                        <div class="">
                          <input type="text" class="form-control" name="nom_banco" id="nom_banco" parsley-trigger="change" readonly="readonly" parsley-required="true" parsley-minlength="4" parsley-validation-minlength="1">
                        </div>
                      </div>
...
<!-- CONTENIDO -->
    ...
    <script src="js/cheques_historial.js"></script>  
    ...
    <!-- tablas -->
      <script src="assets/js/vendor/datatables/dataTablesTrust.js"></script>
