...
if (isset($_REQUEST["cheque_id"])) {
  ...
  echo '<script languaje="JavaScript">  var cheque_id="'.$cheque_id.'"; </script>';
}

date_default_timezone_set('America/Bogota');
  $fecha_mes_dia =  date("M-d");
  $fecha_year =  date("Y");
                ...
                <section class="invoice">
                  ...
                  <div class="header">
                    <div class="row">
                      ...
                      <div class="col-md-4 arrow visible-md-block visible-lg-block">
                      </div>

                      <div class="col-md-4 text-right">
                        <h3><strong>Recibo</strong># <span id="numero_recibo"></span>
